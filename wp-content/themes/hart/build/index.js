...
/* harmony import */ var _modules_PasswordUpdated__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/PasswordUpdated */ "./src/modules/PasswordUpdated.js");
/* harmony import */ var _modules_ChangePicture__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/ChangePicture */ "./src/modules/ChangePicture.js");
...
/* harmony import */ var _modules_PostLike__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/PostLike */ "./src/modules/PostLike.js");
...
for (const header of document.querySelectorAll(".header")) {
  new _modules_Header__WEBPACK_IMPORTED_MODULE_1__["default"](header);
}
for (const menu of document.querySelectorAll(".mobile-menu")) {
  new _modules_MobileMenu__WEBPACK_IMPORTED_MODULE_2__["default"](menu);
}
for (const page of document.querySelectorAll(".password-updated")) {
  new _modules_PasswordUpdated__WEBPACK_IMPORTED_MODULE_3__["default"](page);
}
for (const page of document.querySelectorAll(".change-picture")) {
  new _modules_ChangePicture__WEBPACK_IMPORTED_MODULE_4__["default"](page);
}
for (const postLike of document.querySelectorAll(".post__like")) {
  new _modules_PostLike__WEBPACK_IMPORTED_MODULE_7__["default"](postLike);
}
for (const comments of document.querySelectorAll(".comments")) {
  new _modules_Comments__WEBPACK_IMPORTED_MODULE_8__["default"](comments);
}
const search = new _modules_Search__WEBPACK_IMPORTED_MODULE_5__["default"]();
const contact = new _modules_Contact__WEBPACK_IMPORTED_MODULE_6__["default"]();

/***/ }),

/***/ "./src/modules/ChangePicture.js":
/*!**************************************!*\
  !*** ./src/modules/ChangePicture.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(axios__WEBPACK_IMPORTED_MODULE_0___default().defaults).headers.common["X-WP-Nonce"] = hartData.nonce;
class Comments {
...
class Header {
  ...
  events() {
    //Page scroll
    window.addEventListener("scroll", (0,underscore__WEBPACK_IMPORTED_MODULE_0__.throttle)(this.toggleScrolled.bind(this), 125));
...
/***/ "./src/modules/PasswordUpdated.js":
/*!****************************************!*\
  !*** ./src/modules/PasswordUpdated.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PasswordUpdated);
  ...
  async deletePostLike() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        method: "delete",
        data: {
          likeID: this.postLike.dataset.like
        }
      });
  ...
  async createPostLike() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        method: "post",
        data: {
          postID: this.postLike.dataset.post
        }
      });
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(`${hartData.rootUrl}/wp-json/wp/v2/posts?search=${this.searchInput.value}&per_page=100`);
      if (response.data) {
        let html = "";
          ...
          html += `
						<a class="post-panel search-overlay__result" href="${post.link}">
							...
							<div class="post-panel__inner">
								...
								<time class="post-panel__date">${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(date).format("Do MMMM YYYY")}</time>
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkhart"] = globalThis["webpackChunkhart"] || [];
